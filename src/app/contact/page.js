      ...
      <div className="relative overflow-hidden py-12">
        ...
        <div className="max-w-6xl mx-auto space-y-12 relative">
          ...
          >
            ...
            <motion.div 
              className="lg:col-span-5 bg-slate-900/40 border border-slate-800/80 rounded-2xl p-8 space-y-8 backdrop-blur-sm"
            ...
            >
              ...
              <div className="space-y-6">
                <motion.div className="flex gap-4 items-start" whileHover={{ x: 4 }}>
            ...
            <motion.div 
              className="lg:col-span-7 bg-slate-900/60 border border-slate-800/80 rounded-2xl p-8 backdrop-blur-sm min-h-[400px] flex flex-col justify-center"
              variants={itemVariants}
            >
                  ...
                  >
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-600 transition-all duration-200 outline-none"
                        />
                      </div>
                      <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full bg-slate-950 border border-slate-800 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 rounded-xl px-4 py-3 text-sm text-white placeholder-slate-600 transition-all duration-200 outline-none resize-none"
                      />
                    </div>

                    <motion.button
                      type="submit"
                      className="w-full py-3 bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white font-semibold rounded-xl shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/35 transition-all duration-200 text-sm flex items-center justify-center gap-2 cursor-pointer"
