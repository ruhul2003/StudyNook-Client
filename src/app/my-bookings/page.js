      ...
      <div className="space-y-6 py-4">
        ...
        {loading ? (
          ...
          <div className="text-center py-20 bg-slate-900/50 rounded-3xl border border-slate-850/80">
            <AlertCircle className="w-16 h-16 text-slate-650 mx-auto mb-4" />
            ...
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-indigo-500 to-violet-650 hover:from-indigo-600 hover:to-violet-750 text-white font-bold rounded-xl shadow-lg transition-all"
            >
              Browse Rooms
            </button>
          </div>
                      ...
                      <tr key={booking._id} className="hover:bg-slate-850/20 transition-colors">
                        ...
                        <td className="py-4 px-6 whitespace-nowrap">
                          {booking.status === 'confirmed' ? (
                            ...
                            <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-rose-500/10 text-rose-450 border border-rose-500/20">
                              Cancelled
                            </span>
                          )}
                        </td>
                        ...
                        <td className="py-4 px-6 text-right whitespace-nowrap">
                          {isEligibleForCancel(booking) ? (
                            <button
                              ...
                              className="inline-flex items-center gap-1 px-3 py-1.5 bg-rose-550/10 hover:bg-rose-600 border border-rose-500/20 hover:border-transparent text-rose-400 hover:text-white text-xs font-bold rounded-lg transition-all"
                            >
