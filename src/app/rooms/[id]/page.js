...
export default function RoomDetails() {
  ...
  return (
    <MainLayout title={room.name}>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 py-6 max-w-7xl mx-auto">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-zinc-900 border border-zinc-800">
            ...
            />
            {isOwner && (
              <span className="absolute top-4 right-4 px-3 py-1 bg-zinc-900/90 text-zinc-300 border border-zinc-700 backdrop-blur-sm rounded-md text-xs font-medium tracking-wide">
                Owner Managed
              </span>
            )}
          </div>
          ...
          <div className="space-y-6">
            <div className="flex flex-wrap items-start justify-between gap-4 border-b border-zinc-800 pb-6">
              ...
              <div className="text-xs font-medium tracking-wider uppercase px-3 py-1.5 bg-zinc-800 text-zinc-400 rounded border border-zinc-700/60">
            ...
            <div className="space-y-3">
              ...
              <p className="text-zinc-400 text-sm sm:text-base leading-relaxed whitespace-pre-line max-w-3xl">
                {room.description}
              </p>
            </div>
            ...
            <div className="space-y-3 pt-2">
              ...
              <div className="flex flex-wrap gap-2">
                {room.amenities && room.amenities.map((amenity, index) => (
                  <span
                    key={index}
                    className="px-3 py-1 text-xs font-medium bg-zinc-900 border border-zinc-800 text-zinc-400 rounded-md"
                  >
                    {amenity}
                  </span>
                ))}
                {(!room.amenities || room.amenities.length === 0) && (
                  <span className="text-zinc-600 text-sm italic">No special provisions specified.</span>
                )}
              </div>
            </div>
          </div>
            ...
            <div className="pt-2">
              {user ? (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 px-4 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-lg transition-colors shadow-sm"
                >
                ...
                <button
                  ...
                  className="w-full py-2.5 px-4 bg-zinc-800 hover:bg-zinc-700 text-zinc-200 text-sm font-medium rounded-lg text-center transition-colors border border-zinc-700"
                >
                  Sign In to Book
                </button>
              )}
              ...
              <div className="border-t border-zinc-800 pt-5 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 py-2 px-3 bg-zinc-800 hover:bg-zinc-700 text-zinc-300 rounded-md text-xs font-medium transition-colors border border-zinc-700"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 py-2 px-3 bg-red-950/20 hover:bg-red-950/40 border border-red-900/30 text-red-400 rounded-md text-xs font-medium transition-colors"
                  >
      ...
      {bookingModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs transition-opacity">
          <div className="bg-zinc-900 border border-zinc-800 w-full max-w-md rounded-2xl p-6 space-y-6 shadow-xl max-h-[95vh] overflow-y-auto">
            ...
            <form onSubmit={handleBookingSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-3 pt-2">
                <button
                  ...
                  className="w-1/2 py-2 px-4 bg-transparent hover:bg-zinc-800 text-zinc-400 text-sm font-medium rounded-lg border border-zinc-800 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="w-1/2 py-2 px-4 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-medium rounded-lg transition-colors disabled:opacity-50"
                >
      ...
      {editModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          <div className="bg-zinc-900 border border-zinc-800 w-full max-w-2xl rounded-2xl p-6 space-y-6 shadow-xl max-h-[90vh] overflow-y-auto">
            <h2 className="text-lg font-medium text-zinc-100 flex items-center gap-2">
      ...
      {deleteConfirmOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
          <div className="bg-zinc-900 border border-zinc-800 w-full max-w-sm rounded-2xl p-6 text-center space-y-4 shadow-xl">
            ...
            <div className="flex items-center gap-3 pt-2">
              <button
                ...
                className="w-1/2 py-2 bg-transparent hover:bg-zinc-800 text-zinc-400 text-xs font-medium rounded-lg border border-zinc-800 transition-colors"
              >
                Abort
              </button>
              <button
                ...
                className="w-1/2 py-2 bg-red-600 hover:bg-red-500 text-white text-xs font-medium rounded-lg transition-colors"
              >
                Confirm Deletion
              </button>
            </div>
