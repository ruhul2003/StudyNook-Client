    ...
    <MainLayout title="Home">
      ...
      <section className="relative overflow-hidden py-20 lg:py-32 flex flex-col items-center text-center">
        ...
        <div className="relative max-w-4xl mx-auto space-y-6 px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              href="/rooms"
              className="w-full sm:w-auto px-8 py-3.5 text-base font-semibold bg-gradient-to-r from-indigo-500 to-violet-600 hover:from-indigo-600 hover:to-violet-700 text-white rounded-xl shadow-lg shadow-indigo-500/25 hover:shadow-indigo-500/35 transition-all duration-200"
            >
              Explore Rooms
            </Link>
            <Link
              href="/add-room"
              className="w-full sm:w-auto px-8 py-3.5 text-base font-semibold bg-slate-900 hover:bg-slate-850 text-slate-200 hover:text-white rounded-xl border border-slate-800 hover:border-slate-700 transition-colors"
            >
              List a Room
            </Link>
          </div>
      ...
      <section className="py-16 border-t border-slate-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col items-center text-center p-6 bg-slate-900/40 rounded-2xl border border-slate-900">
      ...
      <section className="py-16 border-t border-slate-900 mb-8">
        <div className="bg-gradient-to-r from-indigo-950/20 to-slate-900/40 rounded-3xl border border-indigo-500/10 p-8 sm:p-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6">
              <div className="p-6 bg-slate-950/80 rounded-2xl border border-slate-900 text-center">
